...
namespace Convolution
{
    ...
    QVector<QVector<float>> join(QVector<QVector<float>> matrixA, QVector<QVector<float>> matrixB);
    ...
    QImage& convolute(const QVector<QVector<float> >& mask,Image& image, options::outOfImagePixelFilling pixelOption);
